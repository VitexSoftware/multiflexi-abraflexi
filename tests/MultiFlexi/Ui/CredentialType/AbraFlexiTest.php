...
use MultiFlexi\Ui\CredentialType\AbraFlexi;
...
class AbraFlexiTest extends TestCase
{
    ...
    {
        $this->assertTrue(class_exists(AbraFlexi::class));
    }

    public function testExtendsCredentialFormHelperPrototype(): void
    {
        $reflection = new \ReflectionClass(AbraFlexi::class);
    ...
    {
        $this->assertTrue(method_exists(AbraFlexi::class, 'finalize'));
    }
}
